...
--Create Dim Tables
IF  NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[TestGrinHouseDW].[edw].[DimGreenhouse]') AND type in (N'U'))

CREATE TABLE [TestGrinHouseDW].[edw].[DimGreenhouse](
	G_ID INT IDENTITY PRIMARY KEY NOT NULL,
	greenhouseId INT NOT NULL,
	greenhouseName NCHAR VARYING(100) NOT NULL
	);

IF  NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[TestGrinHouseDW].[edw].[DimMeasurementType]') AND type in (N'U'))



CREATE TABLE [TestGrinHouseDW].[edw].[DimMeasurementType](
	title NCHAR VARYING(20) PRIMARY KEY NOT NULL CHECK(title IN ('temperature', 'humidity', 'carbonDioxide'))
);


--Create DimDate
IF  NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[TestGrinHouseDW].[edw].[DimDate]') AND type in (N'U'))

CREATE TABLE [TestGrinHouseDW].[edw].[DimDate] (
 D_ID INT NOT NULL,
 Date DATE,
 Day INT,
 Month INT,
...
BEGIN
	INSERT INTO [TestGrinHouseDW].[edw].[DimDate]
	(
		[D_ID],
		[Date],
		[Day],
...
--Create DimTime
IF  NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[TestGrinHouseDW].[edw].[DimTime]') AND type in (N'U'))

-- Then create a new table
CREATE TABLE [TestGrinHouseDW].[edw].[DimTime](
...
BEGIN
    ...
    INSERT INTO [TestGrinHouseDW].[edw].[DimTime] ([Time]
                       , [Hour]
                       , [Minute]
					   , [Seconds])
...
--Create Fact tables
IF  NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[TestGrinHouseDW].[edw].[FactMeasurementTemperature]') AND type in (N'U'))

CREATE TABLE [TestGrinHouseDW].[edw].[FactMeasurementTemperature](
	G_ID INT NOT NULL,
...
IF  NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[TestGrinHouseDW].[edw].[FactMeasurementHumidity]') AND type in (N'U'))

CREATE TABLE [TestGrinHouseDW].[edw].[FactMeasurementHumidity](
	G_ID INT NOT NULL,
	MT_ID NCHAR VARYING(20) NOT NULL,
	D_ID INT NOT NULL,
	T_ID INT NOT NULL,
...
IF  NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[TestGrinHouseDW].[edw].[FactMeasurementCarbonDioxide]') AND type in (N'U'))

CREATE TABLE [TestGrinHouseDW].[edw].[FactMeasurementCarbonDioxide](
	G_ID INT NOT NULL,
	MT_ID NCHAR VARYING(20) NOT NULL,
	D_ID INT NOT NULL,
	T_ID INT NOT NULL,
...
alter table [TestGrinHouseDW].[edw].[FactMeasurementTemperature] drop constraint PK_FactMeasurementTemperature
alter table [TestGrinHouseDW].[edw].[FactMeasurementHumidity] drop constraint PK_FactMeasurementHumidity
alter table [TestGrinHouseDW].[edw].[FactMeasurementCarbonDioxide] drop constraint PK_FactMeasurementCarbonDioxide


drop table [TestGrinHouseDW].[edw].[DimACState]
drop table [TestGrinHouseDW].[edw].[DimHumidifierState]
drop table [TestGrinHouseDW].[edw].[DimCarbonDioxideState]
...
drop table [TestGrinHouseDW].[edw].[FactMeasurementTemperature];
drop table [TestGrinHouseDW].[edw].[FactMeasurementHumidity];
drop table [TestGrinHouseDW].[edw].[FactMeasurementCarbonDioxide];

alter table [TestGrinHouseDW].[edw].[FactMeasurementHumidity] drop constraint FK_H_ID_Humidity

alter table [TestGrinHouseDW].[edw].[FactMeasurementCarbonDioxide] drop constraint FK_H_ID_CarbonDioxide
