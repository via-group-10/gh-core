...
INSERT INTO [TestGrinHouse].[dbo].[MeasurementType] values ('temperature');
INSERT INTO [TestGrinHouse].[dbo].[MeasurementType] values ('humidity');
INSERT INTO [TestGrinHouse].[dbo].[MeasurementType] values ('carbonDioxide');
